...
*                                                                      *
* Bare bones ADXL345ADXL345ADXL345ADXL345ADXL345ADXL345ADXL345 i2c example for Arduino 1.0                       *
...
char INT_SOURCE = 0x30;    // GET INTERUBTS 
uint8_t dataRDY = 7;        // Data ready bit (on INT_SOURCE)
